...
RDEPEND="media-libs/glew[abi_x86_64(-)]
	media-libs/libsdl[abi_x86_64(-),opengl,video,X]
	media-libs/libsndfile[abi_x86_64(-),alsa]
	media-libs/sdl-image[abi_x86_64(-),jpeg,png,tiff]
	media-libs/sdl-ttf[abi_x86_64(-)]
	sys-libs/zlib[abi_x86_64(-)]
	virtual/glu[abi_x86_64(-)]
	x11-libs/gtk+:2[abi_x86_64(-)]"
# Yup, openal and ncurses are only needed at compile-time; the code dlopens it at runtime
# if requested.
DEPEND="${RDEPEND}
	media-libs/openal[abi_x86_64(-)]
	sys-libs/ncurses[abi_x86_64(-),unicode]
	virtual/pkgconfig
	x11-proto/kbproto[abi_x86_64(-)]
	x11-proto/xproto[abi_x86_64(-)]"
...
pkg_postinst() {
	...
	elog
	elog "Optional runtime dependencies: install sys-libs/ncurses[$(use amd64 && echo "abi_x86_64,")unicode]"
	elog "for [PRINT_MODE:TEXT]. Install media-libs/openal$(use amd64 && echo "[abi_x86_64]") for audio output."
	elog
	games_pkg_postinst
}
